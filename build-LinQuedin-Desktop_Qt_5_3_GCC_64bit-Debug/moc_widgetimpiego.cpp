...
void WidgetImpiego::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->enableUpdate((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->enableUpdate((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        default: ;
        }
    }
}
